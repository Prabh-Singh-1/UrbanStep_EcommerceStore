...
const HomePage = () => {
  ...
  const slides = [
    {
      ...
      subtitle: "Discover Premium Sneakers",
  ...
  const featuredProducts = [
    {
      id: 1,
      name: "AirMax Sports Runner",
      price: "₹1899",
      originalPrice: "₹3999",
      image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&h=300&fit=crop",
      rating: 4.8,
      url: "/Products/AirMax Sports Runner",
      isNew: true
    },
    {
      id: 2,
      name: "Retro Red Sneaker",
      price: "₹1499",
      originalPrice: "₹2599",
      image: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=300&h=300&fit=crop",
      rating: 4.6,
      url: "/Products/Retro Red Sneaker",
      isHot: true
    },
    {
      id: 3,
      ...
      rating: 4.9,
      url: "/Products/Classic Brown Loafers",
      isNew: true
    },
    {
      id: 4,
            ...
            <div className="relative h-full">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-white">
                <div className="text-center max-w-4xl px-6">
                  ...
                  <button className={`cursor-pointer bg-white text-gray-900 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
