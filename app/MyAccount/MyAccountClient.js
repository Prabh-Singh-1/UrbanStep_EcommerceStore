...
import { User, MapPin, Lock, CreditCard, Edit2, Save, X } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button
                    onClick={() => {
                        if (isEditingProfile) {
                            handleCancelProfileEdit(); // Call cancel handler if currently editing
                        } else {
                            setIsEditingProfile(true); // Enter editing mode
                        }
                    }}
                    ...
                    {!isEditingAddress ? (
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <div className="flex gap-3 mt-4">
                                ...
                                {/* Cancel button is part of the main toggle */}
                            </div>
                        </div>
                    )}
                </div>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
            <div className="max-w-6xl mx-auto px-4 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">Welcome {session?.user?.name || userCred?.name || 'Guest'}</h1>
                    <p className="text-gray-600">Manage your account settings and preferences</p>
                </div>

                <aside className="flex flex-col lg:flex-row gap-8">
                    {/* Sidebar Navigation */}
                ...
                {/* Removed the global "Save Details" button as section-specific save buttons are implemented */}
            </div>
        </div>
    );
};
